// components/ABATherapyForm.jsx - ABA Therapy Session Form
...
const ABATherapyForm = ({ sessionId = null, userRole }) => {
  ...
  const fetchPatients = async (currentPatientId = null) => {
    try {
      ...
      // Fetch all ABA therapy sessions
      const { data: sessions, error: sessionError } = await supabase
        .from('aba_therapy_sessions')
        .select('patient_id');
      if (sessionError) throw sessionError;

      // Get patient IDs that already have an ABA therapy session
      const sessionPatientIds = new Set((sessions || []).map(s => s.patient_id));

      // Filter patients who do NOT have an ABA therapy session
    ...
    try {
      ...
      if (sessionId) {
        ...
        await logAuditEvent({
          ...
          description: 'ABA therapy session created',
          details: {
            ...
            created_by_user: sessionData.therapist_id,
            user_role: userRole
          }
        });
      ...
      // Navigate back to the ABA therapy list
      navigate('/aba-therapy');
    } catch (error) {
  ...
  return (
    <div className="aba-therapy-form">
        ...
        <div className="card mb-4">
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-md-6">
                {/* Updated Observations Section - using a table format */}
                <div className="mb-3">
