// components/ABATherapyReport.jsx - ABA Therapy Session Report
...
const ABATherapyReport = ({ sessionData, onClose }) => {
  const handlePrint = async () => {
    ...
    await logAuditEvent({
      ...
      description: 'ABA therapy session report printed',
      details: {
  ...
  const handleDownloadPDF = async () => {
    const reportElement = document.getElementById('aba-therapy-report');
    ...
    try {
      ...
      const fileName = `aba_therapy_session_${sessionNumber}_${patientName}.pdf`;
      ...
      await logAuditEvent({
        ...
        resourceType: RESOURCE_TYPES.SESSION,
        resourceId: sessionData.id,
        description: 'ABA therapy session report downloaded as PDF',
        details: {
          session_id: sessionData.id,
          session_type: 'aba_therapy',
    ...
    if (typeof sessionData.progress === 'string') {
      ...
      return (
        <div>
          ...
          <p>{typeof sessionData.progress.notes === 'string' ? (sessionData.progress.notes || 'No additional notes recorded') : 'No additional notes recorded'}</p>
        </div>
      );
    }
  ...
  return (
    <div className="aba-therapy-report">
      <div className="d-flex justify-content-between align-items-center mb-4 no-print">
        <h4 className="mb-0">ABA Therapy Session Report</h4>
        <div>
          <button 
      ...
      <div id="aba-therapy-report" className="report-container">
        <div className="report-header text-center mb-4">
          ...
          <hr />
          <h3 className="report-title mt-4 mb-4">ABA THERAPY SESSION REPORT</h3>
        </div>
        ...
        <div className="footer mt-5">
          <p className="text-center"><em>*This ABA Therapy Session Report is valid for 6 months from the date of release.</em></p>
...
export default ABATherapyReport;
