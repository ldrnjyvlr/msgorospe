// pages/Psychotherapy.jsx - Updated with Progress Object Handling
import React, { useState, useEffect } from 'react';
import { supabase } from '../lib/supabaseClient';
import { FaPlus, FaEye, FaEdit, FaTrash, FaSearch, FaPrint } from 'react-icons/fa';
import PsychotherapyForm from '../components/PsychotherapyForm';
import PsychotherapyReport from '../components/PsychotherapyReport';
import { useNotification } from '../contexts/NotificationContext';
import { logAuditEvent, AUDIT_ACTIONS, RESOURCE_TYPES } from '../utils/auditLogger';

const Psychotherapy = ({ userRole }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await logAuditEvent({
        ...
        description: 'Psychotherapy session deleted',
        details: {
    ...
    return (
      <div className="sessions-list">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h4 className="mb-0">Psychotherapy Sessions</h4>
          <button
              ...
              <table className="table table-hover">
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan="6" className="text-center py-4">
                        No psychotherapy sessions found
                      </td>
                    </tr>
                  )}
                </tbody>
    ...
    if (typeof progress === 'string') {
      ...
      return (
        <div>
          ...
          <p>{progress.notes || 'No additional notes recorded'}</p>
        </div>
      );
    }
  ...
  const renderViewSession = () => {
    ...
    return (
      <div className="view-session">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h4 className="mb-0">Psychotherapy Session Details</h4>
          <div>
            <button
  ...
  const renderAddSession = () => {
    return (
      <div className="add-session">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h4 className="mb-0">New Psychotherapy Session</h4>
          <button
  ...
  const renderEditSession = () => {
    return (
      <div className="edit-session">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h4 className="mb-0">Edit Psychotherapy Session</h4>
          <button
            className="btn btn-outline-secondary"
            onClick={() => handleTabChange('list')}
          >
  ...
  return (
    <div className="psychotherapy-page">
